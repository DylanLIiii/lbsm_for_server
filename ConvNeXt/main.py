...
def get_args_parser():
    ...
    parser.add_argument('--layer-scale-init-value', default=1e-6, type=float,
    ...
    parser.add_argument('--head-init-scale', default=1.0, type=float,
    ...
    parser.add_argument('--data-set', default='IMNET', choices=['CIFAR', 'IMNET', 'image-folder'],
    ...
    parser.add_argument('--wandb-ckpt', type=str2bool, default=False,
